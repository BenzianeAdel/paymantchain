 ...
 */
package com.paymentchain.keycloackAdapter.controler;
...
import com.paymentchain.keycloackAdapter.exception.BussinesRuleException;
...
public class keycloackControler {
    ...
    private Logger logger = LoggerFactory.getLogger(keycloackControler.class);
